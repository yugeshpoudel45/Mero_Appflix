...
class TrendingPeoplePage extends StatefulWidget {
  const TrendingPeoplePage({super.key});

  @override
  State<TrendingPeoplePage> createState() => _TrendingPeoplePageState();
}

class _TrendingPeoplePageState extends State<TrendingPeoplePage> {
  @override
  void initState() {
    super.initState();
